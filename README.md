...
<p align="center">
  <a href="docs/video/演示视频.mp4"><img src="docs/assets/demo_cover.png" alt="演示视频" width="48%"/></a>
  &nbsp;
  <a href="docs/slides/answer_defense.pdf"><img src="docs/assets/slide_cover.png" alt="答辩 PPT" width="48%"/></a>
</p>

<p align="center">
  <a href="docs/video/演示视频.mp4">▶ 演示视频 (4'09")</a>
  &nbsp;·&nbsp;
...
- **演示视频**：[`docs/video/演示视频.mp4`](docs/video/演示视频.mp4)（**4 分 9 秒**，中文神经语音配音，覆盖登录 → 上传 → 索引 → 检索 → 可视化 → 评测 → RAG → admin → SearchLog Dashboard → IndexDetail → SSE / ensemble）。
...
| 演示视频 (4'09") | [`docs/video/演示视频.mp4`](docs/video/演示视频.mp4) | ✅ |
