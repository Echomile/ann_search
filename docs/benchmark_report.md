...
> 静态对比图：导出脚本 ``backend/scripts/alignment_plot.py``，源 JSON ``docs/alignment_offline_3way.json``，PNG 落盘 ``docs/assets/benchmark/alignment_3way.png``。
