...
| 操作系统 | macOS 14（`macOS-26.5-arm64-arm-64bit`，源自 `docs/benchmark_data/benchmark_results.json`）|
...
完整原始数据见 [`docs/benchmark_data/benchmark_results.json`](benchmark_data/benchmark_results.json) 与 [`docs/benchmark_report.md`](benchmark_report.md)，本节仅摘录关键对比。
