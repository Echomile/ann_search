...
| 版本 | 日期 | 主题 | 关键产出 |
| --- | --- | --- | --- |
| **v1.0.0** | 2026-05-23 | 课程要求首版 + 三项加分项 | 21 个 REST 接口 / 21 张 PPT / 9 张验收截图 / 5'54" 演示视频 / 41 commit |
...
3. 第 9-12 张 ↔ 视频 2:30-4:00：可视化 / 评测 / RAG 加分项
4. 第 13-16 张 ↔ 视频 4:00-5:30：v1.0 三项加分（多数据集 / Adaptive HNSW / RAG）
