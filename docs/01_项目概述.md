...
按里程碑划分（详见 1.5）：基础设施与 MVP 约 2 周；ANN 多后端 + 前端联调约 2 周；扩展功能 + 性能调优约 1.5 周；测试 + 文档 + 答辩约 1.5 周。在 7 周内完成全部交付物可行。
...
| 扩展功能 | W5 | 条件过滤 / 跨数据集 / Adaptive-HNSW / RAG | 扩展能力落地 |
...
| 数据集 | `liver.h5ad` (~1.4 GB)，已 git-ignore | [`data/raw/liver.h5ad`](../data/raw/) |
...
| 答辩 PPT | 包含 ER / 架构 / 评测对比 / 扩展能力亮点 | `docs/slides/` |
